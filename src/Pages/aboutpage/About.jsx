    ...
    return (
     ...
     data-aos-easing="ease-in-sine"
          ...
          <div className="flex flex-col justify-center lg:p-6   rounded-sm lg:max-w-md xl:max-w-4xl w-full text-left" >
            <h1 className="text-4xl border-b-2 border-green-500 w-fit font-bold leading-none lg:text-6xl sm:text-4xl"data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="1500">
              About me
            </h1>
            <p className="mt-6 mb-8 text-lg sm:mb-12 text-gray-50 text-opacity-80" data-aos="fade-up"
     data-aos-easing="linear"
